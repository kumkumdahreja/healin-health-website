...
<html lang="en">
 ...
 <?php include '../navbar-for-folders.php'; ?>
    ...
    <div class="error-page">
                ...
                <div class="col-lg-12">
                    <div class="error-page-content">
                        <div class="section-title">
                            <h2 class="text-anime-style-2" data-cursor="-opaque">Coming Soon</h2>
                        </div>
                        <div class="error-page-content-body">
                            <p class="wow fadeInUp" data-wow-delay="0.2s">The page you are looking for will be soon live.</p>
      ...
      <!-- Footer -->
    <?php include '../footer-for-folders.php'; ?>
    <!-- footer ends -->
    </div>
